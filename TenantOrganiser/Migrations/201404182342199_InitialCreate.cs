namespace TenantOrganiser.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Occurance = c.String(nullable: false),
                        HouseId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.House", t => t.HouseId)
                ...
                c => new
                    {
                        ...
                        CleaningRotaId = c.Int(nullable: false),
                        RotaGroup = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.CleaningLog", new[] { "CleaningRotaId" });
            DropIndex("dbo.CleaningRota", new[] { "HouseId" });
            ...
            DropForeignKey("dbo.CleaningLog", "CleaningRotaId", "dbo.CleaningRota");
            DropForeignKey("dbo.CleaningRota", "HouseId", "dbo.House");
