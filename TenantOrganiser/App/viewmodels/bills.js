define(['services/logger', 'durandal/app', 'plugins/router', 'services/datacontext', 'services/session', 'services/model'],
    function (logger, app, router, datacontext, session, model) {
